...
8. **COPD**: only explicit COPD/emphysema/chronic bronchitis language. Bronchiectasis, asthma, and other chronic lung conditions do NOT count (distinct diagnoses).
